...
public class Solution {
    ...
    public static SomeInterfaceWithMethods getProxy() {
        ...
        Class[] intefaces = someInterfaceWithMethodsImpl.getClass().getInterfaces();
        SomeInterfaceWithMethods someInterfaceWithMethods =
                (SomeInterfaceWithMethods) Proxy.newProxyInstance(classLoader, intefaces, new CustomInvocationHandler(someInterfaceWithMethodsImpl));
