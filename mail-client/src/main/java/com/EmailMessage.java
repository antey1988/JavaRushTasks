...
public class EmailMessage {
    ...
    protected static String SMTP_SERVER = null;//"smtp.gmail.com";
    protected static String SMTP_PORT = null;//"465";
    protected static String SMTP_AUTH_USER = null;
    protected static String SMTP_AUTH_PASS = null;
    protected static String EMAIL_FROM = null;
    protected static String FILE_PATH = null;
    protected static String REPLY_TO = null;


    EmailMessage(String emailTo, String thema) {
        ...
        try {
            Authenticator auth = new EmailAuthenticator(SMTP_AUTH_USER, SMTP_AUTH_PASS);
            ...
            if (reply_to != null) message.setReplyTo(new Address[] {reply_to});
    ...
    public boolean sendMessage (String text) {
        ...
        try {
            ...
            if (FILE_PATH != null) {
                MimeBodyPart mimeBodyPart = createFileAttachment(FILE_PATH);
