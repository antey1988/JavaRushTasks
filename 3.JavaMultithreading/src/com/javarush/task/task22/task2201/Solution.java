...
public class Solution {
    public static void main(String[] args) {
        new Solution();
//        System.out.println("1" + new Solution().getPartOfString("\tF\tS\tA\t", "1"));;
    }
...
//        System.out.println(string);
        try {
            String string1 = string.substring(string.indexOf("\t") + 1);
            string1 = string1.substring(0, string1.lastIndexOf("\t"));
            return string1;
        } catch (StringIndexOutOfBoundsException e) {
            if (threadName.equals(Solution.FIRST_THREAD_NAME)) throw new StringForFirstThreadTooShortException(e.toString());
            else if (threadName.equals(Solution.SECOND_THREAD_NAME)) throw new StringForSecondThreadTooShortException(e.toString());
