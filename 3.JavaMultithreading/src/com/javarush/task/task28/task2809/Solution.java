...
public class Solution {
    ...
    /*private static void infoPhaser(Phaser phaser) {
        System.out.println(String.format("phase: %s, regParties: %d, arParties: %d, unarrParties: %d",
                phaser.getPhase(), phaser.getRegisteredParties(), phaser.getArrivedParties(), phaser.getUnarrivedParties()));
